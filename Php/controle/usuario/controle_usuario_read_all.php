...
if ($meuToken->validarToken($autorization) == true) {
    ...
    // Obtém todos os Usuarios do banco de dados
//escolha entre um dos métodos
    $vetor = $objUsuario->readAll(); // vetor de objetos do tipo Usuario
//$vetor = $objUsuario ->readAllToMatrizArrayAssociativo(); //Vetor associativo com os campos da tabela Usuario
